...
* Use `purrr::map2()` to map a function over two vectors or lists in parallel. 

* Use `purrr::pmap()` to map a function over two or more vectors or lists in parallel.

```{r}
# Use fitted model to make prediction: `predict(MODEL, DATA)`
nested_dia %>% 
