...
In some cases, both `gather()` and `spread()` are needed for tidying up data.
...
Figures in this section are from [R for Data Science](http://r4ds.had.co.nz/) by Hadley Wickham and Garrett Grolemund.
