...
1. Data from a typical mass spectrometry-based proteomics experiment.

2. Review tools in base R for common data analysis tasks.
...
As in Task 4, it requires additional efforts to work with model objects, in order to make and combine summaries for all the proteins. Try to answer the following questions: 

* How would you implement a workflow to summarize the means of two groups, difference, $t$-statistic, $p$-value in every protein? 
* Do you see any inconvenience or inconsistency in the workflow? If so, where does the inconvenience come from?
